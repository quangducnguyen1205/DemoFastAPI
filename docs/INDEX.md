...
| [transcript_chunking.md](./transcript_chunking.md) | Current transcript chunking behavior, the previous 200-character strategy, and why the new sentence-aware overlap is better for search-first retrieval. |
